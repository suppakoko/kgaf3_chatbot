...
설치·설정 전반은 [`INSTALL.md`](INSTALL.ko.md), 사용법은 [`USAGE.md`](USAGE.ko.md)를
참고하라.
...
채팅 모드에서의 실제 사용 예시는 [`USAGE.md`](USAGE.ko.md)를 참고하라.
...
설치 전반은 [`INSTALL.md`](INSTALL.ko.md), 사용법은 [`USAGE.md`](USAGE.ko.md)를
참고하라. AF3 브리지는 이와 완전히 별개의 선택 스택이니
[`BRIDGE.md`](BRIDGE.ko.md) / [`AF3_SETUP.md`](AF3_SETUP.ko.md)를 참고하라.
