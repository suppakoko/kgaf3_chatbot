...
> `docs/AF3_SETUP.ko.md`를, 이 저장소에 동봉된 브리지 서버 코드(참조용)는 `af3-bridge/`
> (설명은 `af3-bridge/README.ko.md`)를 참조한다.
...
> AF3 브리지 대책은 GraphRAG에 적용되지 않는다. 배포·사용법은 `docs/GRAPHRAG.ko.md` 참조.
