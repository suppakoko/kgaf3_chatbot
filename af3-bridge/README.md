...
> 한다. 취득·설치 절차는 [`../docs/AF3_SETUP.md`](../docs/AF3_SETUP.md) 참조.
...
검증 절차는 [`../docs/BRIDGE.md`](../docs/BRIDGE.md)에 정리되어 있다.
...
전체 AF3 준비·구동·검증 흐름: [`../docs/AF3_SETUP.md`](../docs/AF3_SETUP.md) ·
브리지 도달성 문제와 대책: [`../docs/BRIDGE.md`](../docs/BRIDGE.md).
